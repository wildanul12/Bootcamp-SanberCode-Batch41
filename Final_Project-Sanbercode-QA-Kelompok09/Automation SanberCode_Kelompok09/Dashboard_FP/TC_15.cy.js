describe('Dashboard Full Sukses', () => {
  it('Verifikasi Dashboard Full Sukses', () => {
    ...
    //10.Verifikasi link back to list sukses, setelah search dan klik delete sukses (Positive) 
    cy.get(':nth-child(3) > :nth-child(7) > .btn-outline-danger').click() //klik button delete setelah search
