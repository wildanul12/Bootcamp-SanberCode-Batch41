describe('Dashboard Full Sukses', () => {
  it('Verifikasi Dashboard Full Sukses', () => {
    ...
    //11.Verifikasi button delete, setelah search sukses (Positive)
    cy.get(':nth-child(2) > :nth-child(7) > .btn-outline-danger').click() //klik button delete setelah search
    cy.get('h2').should('be.visible') //masuk halaman delete sukses
    cy.get('.btn-outline-danger').click().should('be.visible') //klik button delete sukses
